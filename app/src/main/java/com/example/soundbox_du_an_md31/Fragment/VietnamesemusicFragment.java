...
import com.example.soundbox_du_an_md31.databinding.FragmentVietnamesemusicBinding;
...
public class VietnamesemusicFragment extends Fragment {
    private FragmentVietnamesemusicBinding fragmentVietnamesemusicBinding;
    private List<Song> mListSong;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        fragmentVietnamesemusicBinding = FragmentVietnamesemusicBinding.inflate(inflater, container, false);
        fragmentVietnamesemusicBinding.layoutPlayAll.setOnClickListener(v -> {
        ...
        getListNewSongs();
        initListener();
        fragmentVietnamesemusicBinding.iconBackViet.setOnClickListener(v -> backHome());
        fragmentVietnamesemusicBinding.sharePlay.setOnClickListener(v -> sharePlaylist());
        fragmentVietnamesemusicBinding.btnDownload.setOnClickListener(v -> download());
        return fragmentVietnamesemusicBinding.getRoot();
    }
    ...
    private String generatePlaylistShareText() {
        StringBuilder shareText = new StringBuilder("Chia sẽ danh sách nhạc Việt Nam:\n");
        ...
        MyApplication.get(getActivity()).getSongsDatabaseReference().addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                    ...
                    if (song != null && "Vietnam".equals(song.getNation())) {
                        mListSong.add(song);
                    }
                }
    ...
    private void displayListNewSongs() {
        ...
        fragmentVietnamesemusicBinding.rcvData.setLayoutManager(linearLayoutManager);

        SongAdapter songAdapter = new SongAdapter(mListSong, this::goToSongDetail);
        fragmentVietnamesemusicBinding.rcvData.setAdapter(songAdapter);
    }
