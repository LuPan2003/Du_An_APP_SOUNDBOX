...
import com.example.soundbox_du_an_md31.databinding.FragmentUsukBinding;
...
public class UsukFragment extends Fragment {
    private FragmentUsukBinding fragmentUsukBinding;
    private List<Song> mListSong;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        fragmentUsukBinding = FragmentUsukBinding.inflate(inflater, container, false);
        fragmentUsukBinding.layoutPlayAll.setOnClickListener(v -> {
        ...
        getListNewSongs();
        initListener();
        fragmentUsukBinding.iconBackUsuk.setOnClickListener(v -> backHome());
        fragmentUsukBinding.sharePlay.setOnClickListener(v -> sharePlaylist());
        fragmentUsukBinding.btnDownload.setOnClickListener(v -> download());
        return fragmentUsukBinding.getRoot();
    }
    ...
    private String generatePlaylistShareText() {
        StringBuilder shareText = new StringBuilder("Chia sẽ danh sách nhạc Us uk:\n");
        ...
        MyApplication.get(getActivity()).getSongsDatabaseReference().addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                    ...
                    if (song != null && "Usuk".equals(song.getNation())) {
                        mListSong.add(song);
                    }
                }
    ...
    private void displayListNewSongs() {
        ...
        fragmentUsukBinding.rcvData.setLayoutManager(linearLayoutManager);

        SongAdapter songAdapter = new SongAdapter(mListSong, this::goToSongDetail);
        fragmentUsukBinding.rcvData.setAdapter(songAdapter);
    }
