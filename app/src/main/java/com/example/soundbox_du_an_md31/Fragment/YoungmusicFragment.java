...
import com.example.soundbox_du_an_md31.databinding.FragmentYoungmusicBinding;
...
public class YoungmusicFragment extends Fragment {
    private FragmentYoungmusicBinding fragmentYoungmusicBinding;
    private List<Song> mListSong;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        fragmentYoungmusicBinding = FragmentYoungmusicBinding.inflate(inflater, container, false);
        fragmentYoungmusicBinding.layoutPlayAll.setOnClickListener(v -> {
        ...
        getListNewSongs();
        initListener();
        fragmentYoungmusicBinding.iconBackNhactre.setOnClickListener(v -> backHome());
        fragmentYoungmusicBinding.sharePlay.setOnClickListener(v -> sharePlaylist());
        fragmentYoungmusicBinding.btnDownload.setOnClickListener(v -> download());
        return fragmentYoungmusicBinding.getRoot();
    }
    ...
    private String generatePlaylistShareText() {
        StringBuilder shareText = new StringBuilder("Chia sẽ danh sách nhạc trẻ:\n");
        ...
        MyApplication.get(getActivity()).getSongsDatabaseReference().addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                    ...
                    if (song != null && "Pop".equals(song.getGenre()) || "Nhạc Trẻ".equals(song.getGenre())) {
                        mListSong.add(song);
                    }
                }
    ...
    private void displayListNewSongs() {
        ...
        fragmentYoungmusicBinding.rcvData.setLayoutManager(linearLayoutManager);

        SongAdapter songAdapter = new SongAdapter(mListSong, this::goToSongDetail);
        fragmentYoungmusicBinding.rcvData.setAdapter(songAdapter);
    }
