...
import com.example.soundbox_du_an_md31.databinding.FragmentEdmmusicBinding;
...
public class EdmmusicFragment extends Fragment {
    private FragmentEdmmusicBinding fragmentEdmmusicBinding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fragmentEdmmusicBinding.sharePlay.setOnClickListener(v -> sharePlaylist());
        fragmentEdmmusicBinding.btnDownload.setOnClickListener(v -> download());
    ...
    private String generatePlaylistShareText() {
        StringBuilder shareText = new StringBuilder("Chia sẽ danh sách EDM \n");
        ...
        MyApplication.get(getActivity()).getSongsDatabaseReference().addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                    ...
                    if (song != null && "Classical".equals(song.getGenre())) {
                        mListSong.add(song);
                    }
                }
                displayListNewSongs();
    ...
    private void displayListNewSongs() {
        ...
        fragmentEdmmusicBinding.rcvData.setLayoutManager(linearLayoutManager);

        SongAdapter songAdapter = new SongAdapter(mListSong, this::goToSongDetail);
        fragmentEdmmusicBinding.rcvData.setAdapter(songAdapter);
    }
