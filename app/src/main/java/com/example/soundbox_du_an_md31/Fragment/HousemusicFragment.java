...
public class HousemusicFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fragmentHousemusicBinding.layoutPlayAll.setOnClickListener(v -> {
        ...
        fragmentHousemusicBinding.sharePlay.setOnClickListener(v -> sharePlaylist());
        fragmentHousemusicBinding.btnDownload.setOnClickListener(v -> download());
    ...
    private String generatePlaylistShareText() {
        StringBuilder shareText = new StringBuilder("Chia sẽ danh sách nhạc House:\n");
