...
import com.example.soundbox_du_an_md31.databinding.FragmentChinesemusicBinding;
...
public class ChinesemusicFragment extends Fragment {
    private FragmentChinesemusicBinding fragmentChinesemusicBinding;
    private List<Song> mListSong;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        fragmentChinesemusicBinding = FragmentChinesemusicBinding.inflate(inflater, container, false);
        fragmentChinesemusicBinding.layoutPlayAll.setOnClickListener(v -> {
        ...
        getListNewSongs();
        initListener();
        fragmentChinesemusicBinding.iconBackTrung.setOnClickListener(v -> backHome());
        fragmentChinesemusicBinding.sharePlay.setOnClickListener(v -> sharePlaylist());
        fragmentChinesemusicBinding.btnDownload.setOnClickListener(v -> download());
        return fragmentChinesemusicBinding.getRoot();
    }
    ...
    private String generatePlaylistShareText() {
        StringBuilder shareText = new StringBuilder("Chia sẽ danh sách nhạc trung hoa:\n");
        ...
        MyApplication.get(getActivity()).getSongsDatabaseReference().addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                    ...
                    if (song != null && "China".equals(song.getNation())) {
                        mListSong.add(song);
                    }
                }
    ...
    private void displayListNewSongs() {
        ...
        fragmentChinesemusicBinding.rcvData.setLayoutManager(linearLayoutManager);

        SongAdapter songAdapter = new SongAdapter(mListSong, this::goToSongDetail);
        fragmentChinesemusicBinding.rcvData.setAdapter(songAdapter);
    }
