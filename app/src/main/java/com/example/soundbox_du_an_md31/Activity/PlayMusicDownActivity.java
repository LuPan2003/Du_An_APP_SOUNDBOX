...
import com.example.soundbox_du_an_md31.Adapter.MusicViewPagerDownAdapter;
import com.example.soundbox_du_an_md31.R;
import com.example.soundbox_du_an_md31.databinding.ActivityPlayMusicBinding;
import com.example.soundbox_du_an_md31.databinding.ActivityPlayMusicDownBinding;

public class PlayMusicDownActivity  extends BaseActivity implements SensorEventListener {

    private ActivityPlayMusicDownBinding mActivityPlayMusicBinding;
    private float lastX = 0.0f;
    private static final float SHAKE_THRESHOLD = 5.0f;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mActivityPlayMusicBinding = ActivityPlayMusicDownBinding.inflate(getLayoutInflater());
    ...
    private void initUI() {
        MusicViewPagerDownAdapter musicViewPagerAdapter = new MusicViewPagerDownAdapter(this);
